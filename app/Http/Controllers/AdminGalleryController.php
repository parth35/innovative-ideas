...
class AdminGalleryController extends Controller
{
	...
	public function edit($id)
	{
		...
		$tags_link = \App\PhotosTag::select('tag_id')->where('photo_id',$id)->get()->toArray();
		$tag_arr = array();
		foreach($tags_link as $tag)
		{
			$tag_arr[] = $tag['tag_id'];
		}
		return view('admin.modules.gallery.edit',['title' => $title, 'id' => $id, 'photo' => $photo, 'tags' => $tags, 'users' => $users, 'tags_link' => $tag_arr]);
	}
	...
	public function delete($id)
	{
		...
		$photo_delete->delete();
		$delete_photo_link = \App\PhotosTag::where('photo_id',$id)->delete();
	...
	public function delete_all(Request $r)
	{
		...
		foreach($input['datachecked'] as $photo)
		{
			...
			$photo_status->delete();
			$delete_photo_link = \App\PhotosTag::where('photo_id',$photo)->delete();
		}
